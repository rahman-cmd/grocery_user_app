...
import 'package:sixam_mart/view/screens/wallet/widget/add_fund_dialogue.dart';
            ...
            Stack(children: [
              ...
              fromWallet && Get.find<SplashController>().configModel!.addFundStatus! ? Positioned(
                ...
                child: InkWell(
                  onTap: (){
                    Get.dialog(
                      const Dialog(backgroundColor: Colors.transparent, child: SizedBox(width: 500, child: AddFundDialogue())),
                    );
                  },
                  child: Container(
