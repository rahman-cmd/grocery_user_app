...
class PaymentSection extends StatelessWidget {
  ...
  const PaymentSection({Key? key, this.storeId, required this.isCashOnDeliveryActive, required this.isDigitalPaymentActive, required this.isWalletActive, required this.total, required this.orderController, }) : super(key: key);
