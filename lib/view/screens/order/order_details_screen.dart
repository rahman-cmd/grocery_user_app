...
import 'package:sixam_mart/view/screens/order/widget/order_calcuation_widget.dart';
import 'package:sixam_mart/view/screens/order/widget/order_info_widget.dart';
...
/*                  !ResponsiveHelper.isDesktop(context) ?
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              order.paymentMethod == 'cash_on_delivery' ? 'cash_on_delivery'.tr : order.paymentMethod == 'wallet' ? 'wallet_payment'.tr 
                  ...
                  (Get.find<SplashController>().getModuleConfig(order.moduleType).orderAttachment! && order.orderAttachment != null
                    ...
                    order.deliveryMan != null ? Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(children: [
                          ...
                          (order.orderStatus != 'delivered' && order.orderStatus != 'failed' && order.orderStatus != 'canceled'
                          && order.orderStatus != 'refunded') ? Row(children: [
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(children: [
                          ...
                          Image.asset(
                            order.paymentMethod == 'cash_on_delivery' ? Images.codIcon
                      ...
                      child: Column(
                        children: [
                          parcel ? const SizedBox() : Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            SizedBox(height: additionalCharge != 0 ? 10 : 0),

                            additionalCharge != 0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Text(Get.find<SplashController>().configModel!.additionalChargeName!, style: robotoRegular),
                              Text(
                                '(+) ${PriceConverter.convertPrice(additionalCharge)}', style: robotoRegular, textDirection: TextDirection.ltr,
                              ),
                            ]) : const SizedBox(),
                          ]),
                        ],
                    ...
                    ResponsiveHelper.isDesktop(context) ? Padding(
                        ...
                        child: _bottomView(orderController, order, parcel, total)) : const SizedBox(),
