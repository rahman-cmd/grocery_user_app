...
class PaymentWebViewScreen extends StatefulWidget {
  ...
  const PaymentWebViewScreen({Key? key, required this.orderModel, required this.isCashOnDelivery, this.addFundUrl, required this.paymentMethod}) : super(key: key);
          ...
          children: [
            InAppWebView(
              ...
              onLoadStart: (controller, url) async {
                ...
                Get.find<OrderController>().paymentRedirect(url: url.toString(), canRedirect: _canRedirect, onClose: (){} , addFundUrl: widget.addFundUrl, orderID: widget.orderModel.id.toString());
                setState(() {
                  _isLoading = true;
                });
              },
