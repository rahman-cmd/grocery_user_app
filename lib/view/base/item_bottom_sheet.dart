          ...
          children: [
            ...
            Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                // Addons
                (Get.find<SplashController>().configModel!.moduleConfig!.module!.addOn! && widget.item!.addOns!.isNotEmpty) ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                ...
                (!widget.item!.scheduleOrder! && !isAvailable) ? const SizedBox() : Row(children: [
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      minimumSize: const Size(50, 50), backgroundColor: Theme.of(context).cardColor, shape: RoundedRectangleBorder(
                      ...
                      if(_newVariation!) {
                        for(int index=0; index<widget.item!.foodVariations!.length; index++) {
                          if(!widget.item!.foodVariations![index].multiSelect! && widget.item!.foodVariations![index].required!
                            ...
                            invalid = '${'you_need_to_select_minimum'.tr} ${widget.item!.foodVariations![index].min} '
    ...
    return item!.foodVariations != null ? ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            itemBuilder: (context, i) {
              return InkWell(
                ...
                child: Row(children: [
                  ...
                  Text(
                    item!.foodVariations![index].variationValues![i].optionPrice! > 0 ? '+${PriceConverter.convertPrice(item!.foodVariations![index].variationValues![i].optionPrice)}' : 'free'.tr,
          ...
          SizedBox(height: index != item!.foodVariations!.length - 1 ? Dimensions.paddingSizeLarge : 0),
        ]);
      },
    ) : const SizedBox();
  }
